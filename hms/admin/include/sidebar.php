			...
			<li>
				<a href="javascript:void(0)">
					<div class="item-content">
						...
						<div class="item-inner">
							<span class="title"> Cabin </span><i class="icon-arrow"></i>
						</div>
					</div>
				</a>
				<ul class="sub-menu">
					<li>
						<a href="add-cabin.php">
							<span class="title"> Add Cabin </span>
						</a>
					</li>
					<li>
						<a href="manage-cabin.php">
							<span class="title"> Manage Cabin </span>
						</a>
					</li>
					<li>
						<a href="available-cabin.php">
							<span class="title"> Cabin Availability </span>
						</a>
					</li>
