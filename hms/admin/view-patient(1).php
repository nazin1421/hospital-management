...
<td colspan="4" style="font-size:20px;color:blue">
 Patient Details</td></tr>
  ...
  <tr>
    <th>Patient Activ Day</th>
    <td><?php  echo $row['day'];?></td>
    <th>Total Taka</th>
    <td><?php  echo $row['day']*$row['cabin_price'];?></td>
  </tr>
  <tr>
...
<p align="center">                            
 <a href="manage-patient.php?Pyment=<?php echo $row['viewid'];?>"><button class="btn btn-primary waves-effect waves-light w-lg">Discharge patient</button></p>
