...
<html>
	<head>
		<title>Patient administration system</title>
	...
	<body>
			...
			<div class="header">
				<div class="wrap">
				<div class="logo">
					<a href="index.php" style="font-size: 30px;">Patient administration system</a>
				</div>
		...
		<div class="clear"> </div>
					...
					<div class="image-slider">
					    ...
					    <ul class="rslides" id="slider1">
					      <li><img src="images/mmedical2.jpg" alt=""></li>
					    </ul>
					</div>
		    ...
		    <div class="content-grids">
				...
				<div class="listview_1_of_3 images_1_of_3">
					...
					<!-- <div class="text list_1_of_2">
						  ...
						  <div class="button"><span><a href="hms/employe/">Click Here</a></span></div>
					</div> -->
					<div class="text list_1_of_2">
						  <h3>Doctors Login</h3>
